...
# Quick Data Cleaning: Convert 'Survived' to readable labels for the graph
df['Status'] = df['Survived'].map({0: 'Perished', 1: 'Survived'})

# Create a visualization: Survival count by Gender and Class
plt.figure(figsize=(10, 6))
sns.countplot(data=df, x='Pclass', hue='Status', palette='viridis')
